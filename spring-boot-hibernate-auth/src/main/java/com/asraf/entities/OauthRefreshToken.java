 ...
 */
@Entity
@Table(name = "oauth_refresh_token", catalog = "myauthdb")
public class OauthRefreshToken extends BaseEntity implements java.io.Serializable {
	...
	@AttributeOverrides({ @AttributeOverride(name = "tokenId", column = @Column(name = "token_id")),
